...
====================
All LLM prompt strings for the 3-stage Text-to-SQL pipeline.

Stage 1 → DECOMPOSE  : natural language → structured JSON components
Stage 2 → GENERATE   : structured JSON → SQL SELECT query
Stage 3 → FIX        : broken SQL + error message → corrected SQL
"""

# ---------------------------------------------------------------------------
# Shared database context injected into every prompt
# ---------------------------------------------------------------------------
_DB_SCHEMA = """
